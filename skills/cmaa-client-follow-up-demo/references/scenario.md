...
| Field | Value |
| --- | --- |
| Business | RAMP Manufacturing / LITEBAND |
| Record ID | `DEMO-NEO-141-0742` |
| Program | APEX |
| Location | Arlington Heights, Illinois |
| Requested support | Government contracting readiness |
| Intake stage | Accepted pre-client |
| Assigned advisor | Ian Quan |
| Preferred language | English |
| Last touch | 9 days ago |
| Next milestone | First APEX strategy session |
| Outstanding work | Capability statement, SAM.gov status, two incomplete intake fields |
| Opportunity deadline | 12 days |

The Neoserra fields above are simulated. RAMP's public government and military positioning may be researched from `https://rampmfg.com/government-military/`.
